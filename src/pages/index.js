  ...
  return (
      <>
        <section className="flex flex-col justify-end h-[calc(100vh-64px)]">
          <h1 className="text-4xl font-bold mb-4">Producer turned<br />front-end developer.</h1>
          <p className="text-xl mb-4">Wait –what?</p>
          <p>Freshly converted developer with 8 years of agency and studio experience, managing web projects for clients small and large. Now getting my hands dirty to build cool stuff 😈</p>
        </section>
        <section className="mt-16 mb-16">
          <h2 className="text-6xl font-bold mb-8">Selected work.</h2>
          <div className="flex flex-col gap-8">
            {highlightedProjects.map((project) => (
              <Link key={project.slug} href={`/projects/${project.slug}`} className="max-w-[1200px]">
